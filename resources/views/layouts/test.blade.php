    ...
    <aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white">
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav class="mx-3 space-y-3 ">
                <a class="flex items-center px-3 py-2 text-gray-800 transition-colors duration-300 transform rounded-lg dark:hover:border-gray-800 text-gray-800 dark:hover:border-black hover:bg-green-200 hover:text-green-500 hover:text-green-700" href="#">
