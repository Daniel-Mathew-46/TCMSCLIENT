                ...
                {!! Form::open(array('route' => 'provider_categories.store','method'=>'POST')) !!}
                    <div class="grid grid-cols-6 gap-6 mb-2">
                        <div class="col-span-6 sm:col-span-3">
                            <label for="full_name" class="text-sm font-medium text-gray-900 block mb-2 dark:text-white">Provider Category Name</label>
                            {!! Form::text('prov_categ_name', null, array('placeholder' => 'Prov.Category Name','class' => 'shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white')) !!}
                        </div>
                    </div>
