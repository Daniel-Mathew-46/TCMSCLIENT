    ...
    <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
        ...
        <div class="bg-white rounded-lg shadow relative">
            ...
            <div class="flex items-start justify-between p-5 border-b rounded-t">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="show-pc-modal{{$provider_category['id']}}">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="items-center p-6 border-t border-gray-200 rounded-b mb-2">
                    <button class="text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" data-modal-toggle="show-pc-modal{{$provider_category['id']}}">Ok</button>
                </div>
            </div>
        </div>
    </div>
