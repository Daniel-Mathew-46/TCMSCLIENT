...
<div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
  <div class="mb-1 w-full">
      <div class="sm:flex">
          <div class="mb-4">
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Customers Management</h1>
          </div>
                  ...
                  <tbody class="">
                    @foreach ($customers as $key => $customer)
                      <tr class="">
                          ...
                          <td class="">
                            @can('customer-show')
                            <button type="button" data-modal-toggle="show-customer-modal{{$customer['id']}}" class="justify-center text-white bg-teal-500 hover:bg-teal-800 focus:ring-4 focus:ring-teal-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center ">
                            ...
                            <button type="button" data-modal-toggle="edit-customer-modal{{$customer['id']}}" class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                            ...
                            @endcan 
                            @can('customer-assigndebt')
                            <button type="button" data-modal-toggle="assign-debt-modal{{$customer['id']}}" class="text-white bg-gray-500 hover:bg-gray-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path>
                                    <path  d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"></path>
                                </svg>
                            ...
                            @include('customer.modal.assigndebt')
                          </td>
                      </tr>
                    @endforeach
                  </tbody>
