{{-- Edit User Modal {utilityProviders: [{id: 1, provider_name: 'Dawasco'}, {id: 2, provider_name: 'Tanesco'}]} --}}
                ...
                <form action="#">
                    <div class="grid grid-cols-6 gap-6 mb-2">
                        <div class="hidden col-span-6 sm:col-span-3">
                            <label for="id" class="text-sm font-medium text-gray-900 mb-2">Id</label>
                            <input type="text" name="id" id="id" value="{{$user['id']}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Bonnie" required>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            <label for="first-name" class="text-sm font-medium text-gray-900 block mb-2">Full Name</label>
                            <input type="text" name="full_name" id="full_name" value="{{$user['full_name']}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Bonnie" required>
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="number" name="phone-number" id="phone-number" value="0{{ $user['phone_number'] }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" disabled>
                        </div>
                        ...
                        <div x-show="utilityProviders" class="col-span-6 sm:col-span-3">
                            ...
                            <select id="utilityProviderSelect" x-bind:value="selectedRole === 'Admin' ? null : selectedProvider" x-bind:disabled="selectedRole === 'Admin'" x-on:change="selectedProvider = $event.target.value"
