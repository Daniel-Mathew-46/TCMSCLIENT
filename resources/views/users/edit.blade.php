                ...
                {!! Form::model($user, ['method' => 'PATCH','route' => ['users.update', $user['id']]]) !!}
                    <div class="grid grid-cols-6 gap-6 mb-2">
                        <div class="col-span-6 sm:col-span-3">
                            <label for="name" class="text-sm font-medium text-gray-900 block mb-2 dark:text-white"> Name</label>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="phone_number" id="phone_number" value="0{{ $user['phone_number'] }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" placeholder="Phone Number" >
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            {!! Form::select('roles', $roles, $userRole, array('id'=> 'roleSelect', 'class' => 'shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white')) !!}
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                            <label for="utility_provider_id" class="text-sm font-medium text-gray-900 block mb-2 dark:text-white">Utility Provider</label>
                            {!! Form::select('utility_provider', $utility_providers, $userUtilityProvider, array('id' => 'utilityProviderSelect', 'class' => 'shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white')) !!}
                        </div>
                        <div class="col-span-6 sm:col-span-3">
