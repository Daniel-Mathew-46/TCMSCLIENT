            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-6 gap-6 mb-2">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="role-name" id="role-name" value="{{$role->name}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" disabled>
                    </div>
                    {{-- <div class="col-span-6 sm:col-span-3">
