...
<div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
  <div class="mb-1 w-full">
      <div class="sm:flex">
          <div class="mb-4">
            <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Roles</h1>
          </div>
                  ...
                  <tbody class="">
                    @foreach ($roles as $key => $role)
                      <tr class="">
                          ...
                          <td class="">
                            <button type="button" data-modal-toggle="show-role-modal{{$role->id}}" class="justify-center text-white bg-teal-500 hover:bg-teal-800 focus:ring-4 focus:ring-teal-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center ">
                            ...
                            @can('role-edit')
                            <button type="button" data-modal-toggle="edit-role-modal{{$role->id}}" class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                            ...
                            @endcan
                            @can('role-delete')
                            <button type="button" data-modal-toggle="delete-role-modal{{$role->id}}" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
